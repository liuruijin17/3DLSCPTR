...
from db.tools.utils import *
from db.tools.MinCostFlow import SolveMinCostFlow
...
class LaneEval(object):
    def __init__(self, db):
        ...
        # print(self.K)
        # print(self.no_centerline)
        # print(self.resize_h)
        # print(self.resize_w)
        # print(db.org_h, db.org_w, db.crop_y, db.resize_h, db.resize_w)
        # print(db.top_view_region)
        # exit()
    ...
    def bench_one_submit_varying_probs(self, pred_file, gt_file, eval_out_file=None, eval_fig_file=None):
        ...
        for i in tqdm(range(0, len(json_pred)), ncols=67, desc="Evaluating sample"):
            pred = json_pred[i]
        # for i, pred in enumerate(json_pred):
