...
class NetworkFactory(object):
    def __init__(self, db, flag=False, freeze=False):
        ...
        if 'Pv' in system_configs.snapshot_file:
            module_file = "models.Pv-stage"
        elif 'Tv' in system_configs.snapshot_file:
            module_file = "models.Tv-stage"
        else:
            raise ValueError('Invalid snapshot_file: {}'.format(system_configs.snapshot_file))
