...
class AELoss(nn.Module):
    def __init__(self,
        ...
        matcher = build_matcher(set_cost_class=weight_dict['loss_ce'],
                                poly_weight=weight_dict['loss_3dspace_XS'],
                                lower_weight=weight_dict['loss_3dspace_lowers'],
                                upper_weight=weight_dict['loss_3dspace_uppers'],
    ...
    def forward(self,
        ...
        loss_dict, indices = self.criterion(outputs, gt_2dgflatlanes, gt_2dgflatflags, gt_heights, gt_pitches)
