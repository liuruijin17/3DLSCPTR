...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets, targets_flag):
        ...
        # print('out_bbox.shape: {}'.format(out_bbox.shape));exit()  # B, num_queries, kps_dim
        ...
        out_polys = out_bbox[:, :, :4].view((-1,4))
        out_2poly = out_bbox[:, :, :4].view((-1,4))
        ...
        out_gflatxs = out_polys[:, 0] * tgt_gflatys ** 1 + \
                      out_polys[:, 0] * tgt_gflatys ** 1 + \
                      out_polys[:, 0] * tgt_gflatys + \
                      out_polys[:, 0]
        ...
        out_gflatzs = out_2poly[:, 0] * tgt_gflatys ** 1 + \
                      out_2poly[:, 0] * tgt_gflatys ** 1 + \
                      out_2poly[:, 0] * tgt_gflatys + \
                      out_2poly[:, 0]
